...
data {
    ...
    vector[n_tot] ele; 
    //int ele_midpoint_f[n_tot]; //ele midpoint index, cut in 200m intervals.
...
parameters {
    ...
    // flexible habitat elevation effect
    //vector[n_ele_midpoint_f] b5;
    ...
    //real<lower=0> sigma_b2_upr;
    //vector[n_species] b2_upr_z;
